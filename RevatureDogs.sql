...
CREATE TABLE RD.Dogs (
	...
	PetName nvarchar(30) NOT NULL, /* User has to give their pet a name when adopting. */
	Hunger int DEFAULT 100, /* Hunger level ranges from 0 to 100. */
	Mood nvarchar(30) DEFAULT 'Happy',
...
CREATE TABLE RD.Tricks (
	Id int PRIMARY KEY IDENTITY,
	TrickName nvarchar(30) NOT NULL,
	TrickBenefit nvarchar(30) NOT NULL,
	Diffculty int NOT NULL, /* Denotes how many times a trick has to be practiced to be learned. */
	Points int NOT NULL /* Points are added to the user's score when the trick is taught. */
);
